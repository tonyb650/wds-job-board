...
const OrderCompletePage = () => {
  const { messagePromise } = useLoaderData<typeof OrderCompleteLoader>();
...
/*
THIS COMPONENT BASED ON STRIPE DOCUMENTATION - works fine, but adjusting to match Kyle's 
...
export default function CompletePage() {
  const { status, intentId } = useLoaderData<typeof OrderCompleteLoader>()
